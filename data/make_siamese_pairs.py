...
"""
pos = pd.read_csv('/home/gloria/projects/siamese-triplet/data/womac5up_ver00.csv', index_col=None)
...
train_set.to_csv('data/womac_pairs05_train.csv',index=False)
test_set = all.iloc[test_index].sort_values(by='ID')
test_set.to_csv('data/womac_pairs05_test.csv',index=False)
all.to_csv('data/womac_pairs05.csv',index=False)

train_set[:20].to_csv('data/part_train.csv',index=False)
test_set[:6].to_csv('data/part_test.csv',index=False)